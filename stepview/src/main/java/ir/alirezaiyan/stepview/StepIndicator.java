...
package ir.alirezaiyan.stepview;
...
public class StepIndicator extends View {
    ...
    private static final int DEFAULT_TEXT_COLOR = R.color.step_default;
    private static final int DEFAULT_SECONDARY_TEXT_COLOR = R.color.current_step_default;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        pText.setTextSize((float) (radius * 1.2));

        Typeface typeface = ResourcesCompat.getFont(context, R.font.awesome);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < stepsCount; i++) {
            ...
            try {
                drawTextCentred(canvas, pText, icons[i], pointX, centerY);
            } catch (Exception e) {
            }
